function PayoffsUI(config){
	...
	// Labels
	dom.appendChild(_makeLabel("label_cooperate", {x:165, y:17, rotation:45, align:"center", color:"#cccccc"}));
	dom.appendChild(_makeLabel("label_cooperate", {x:82, y:17, rotation:-45, align:"center", color:"#cccccc"}));
