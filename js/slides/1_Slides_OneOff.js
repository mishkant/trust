...
SLIDES.push({
	...
	onstart: function(self){
		...
		// Buttons
		self.add({
			id:"btnCheat", type:"Button", x:275, y:463, text_id:"label_cheat", uppercase:false,
			onclick:function(){
				_.answer = "CHEAT";
		...
		self.add({
			id:"btnCooperate", type:"Button", x:495, y:460, text_id:"label_cooperate", uppercase:false,
			onclick:function(){
				_.answer = "COOPERATE";
				publish("slideshow/next");
			}
